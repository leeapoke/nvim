...
if not vim.g.vscode then
  ...
  -- copy relative path
  vim.cmd([[
command! -nargs=0 CpRelativePath lua require("custom.utils.utils").copy_relative_path()
]])

  -- copy relative path
  vim.cmd([[
command! -nargs=0 CpFileName lua require("custom.utils.utils").copy_current_filename()
]])

  -- copy absolute path
  vim.cmd([[
command! -nargs=0 CpAbsolutePath lua require("custom.utils.utils").copy_absolute_path()
]])
